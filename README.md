...
* you may use the structure described in minesweeper.js to keep the state and apply logic or you can write everything from scratch
...
Make sure to read the mentions in the minesweeper.js file for tips.
